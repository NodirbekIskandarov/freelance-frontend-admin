...
export function PageHeader({
  ...
  breadcrumbs?: Crumb[];
  /**
   * 14-rasmda breadcrumb sarlavhadan YUQORIDA, qolgan ekranlarda pastida.
   */
  breadcrumbsPosition?: 'below' | 'above';
  actions?: ReactNode;
  className?: string;
}) {
  const crumbs = breadcrumbs && breadcrumbs.length > 0 && (
    <nav aria-label="Breadcrumb" className={breadcrumbsPosition === 'above' ? 'mb-2' : 'mt-1.5'}>
